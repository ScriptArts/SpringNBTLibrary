...
| [Java](docs/getting-started/java.md) | Java 21 (LTS) | `spring-nbt-library.jar` | クラスパスへ追加 |
| [TypeScript](docs/getting-started/typescript.md) | Node.js 20+ | `spring-nbt-library.tgz` | `npm install ./<ファイル>` |
